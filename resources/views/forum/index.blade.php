    ...
    <div class="jumbotron" id="tc_jumbotron" style="background-color: rgb(1 51 233);">
        <div class="card-body" id="xx" style="color: #fff; border:1px solid #fff;">
            <div class="text-center">
                ...
                <p>Forum Diskusi dan Tanya Jawab Mengenai Bahasa Pemrograman. </p>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="card-body" id="tc_panelbody" style="background: #f9f9f9;">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-btn">
                                            <button class="btn btn-warning" type="button"
                                                style="color: #fff;background: rgb(14 14 14)">Go!</button>
                                        </span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                                    ...
                                    <tr>
                                        <td width="453">
                                            <div class="forum_title">
                                                <h4> <a href="{{route('forumslug', $forum->slug)}}"
                                                        style="color: rgb(1 51 233)">{{str_limit($forum->title, 40)}}</a>
                                                </h4>
                                                <p> {!! strip_tags(str_limit($forum->description, 60) ) !!}</p>
                                                @foreach($forum->tags as $tag)
                                                <a href="#" class="badge badge-success tag_label"
                                                    style="background: rgb(1 51 233)">#{{$tag->name}}</a>
                                                @endforeach
                                                @if(empty($forum->image))
                                                @else
                                                <div class="badge badge-success tag_label_image"
                                                    style="background: rgb(1 51 233)"><i class="fa fa-image"></i></div>
                                                @endif
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <div class="forum_by">
                                                ...
                                                <small>by <a href="{{ route('profile', $forum->user->name) }}"
                                                        style="color: rgb(1 51 233)">{{$forum->user->name}}</a></small>
                                            </div>
                                        </td>
                                    </tr>
                                    @endforeach
                        ...
                        <div class="col-md-4"> <br>
                            <a href="{{route('forum.create')}}" class="btn btn-success btn-block"
                                style="background: rgb(1 51 233)">Buat Pertanyaan</a><br>
